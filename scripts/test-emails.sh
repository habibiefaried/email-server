...
swaks --to testuser@example.com \
      ...
      --server "$SMTP_HOST:$SMTP_PORT" \
      --header "Subject: Test Email 3 - Special Chars: 日本語 🎉" \
      --body "Testing special characters: áéíóú ñ 中文 日本語 한글 🚀 ✅ 💯" \
      && echo "✓ Email 3 sent successfully" \
...
swaks --to anotheruser@example.com \
      ...
      && echo "✓ Email 4 sent successfully" \
...
swaks --to testuser@example.com \
      ...
      && echo "✓ Email 5 sent successfully" \
      || echo "✗ Failed to send email 5"

echo -e "\n================================================"
echo "✓ All 5 test emails sent!"
echo "================================================"
echo ""
echo "To verify, check the API:"
echo "  curl \"http://localhost:48080/inbox?name=testuser@example.com\" | jq"
echo "  curl \"http://localhost:48080/inbox?name=anotheruser@example.com\" | jq"
echo ""
